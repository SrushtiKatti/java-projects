...
public class NextLineTrap {
    public static void main(String[] args) {
        ...
        System.out.print("\nEnter a greeting: ");
        scanner.nextLine(); // Consume the newline character left by nextInt() throwaway
        ...
        scanner.nextLine(); // Consume the newline character left by nextDouble() throwaway
        ...
        scanner.nextLine(); // Consume the newline character left by nextLong() throwaway
        ...
        scanner.nextLine(); // Consume the newline character left by next() throwaway
